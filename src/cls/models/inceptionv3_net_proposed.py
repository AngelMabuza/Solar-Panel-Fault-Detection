...
def build_inceptionv3_net_proposed(input_shape=(256, 256, 3), num_classes=6, lr=1e-4, base_trainable=False):
    ...
    model = Model(inputs=base.input, outputs=out, name="inceptionv3_net_proposed")
